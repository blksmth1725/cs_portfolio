...
const Contact = () => {
  ...
  return (
    <div className="section-content">
      <div className="introduction-email">{email}</div>
      <div className="introduction-phone">{phone}</div>
      <div className="introduction-location">{location}</div>
      <div className="introduction-social-media">
        ...
        <div className="introduction-linkedin">
