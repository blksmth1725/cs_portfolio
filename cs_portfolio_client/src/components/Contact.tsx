...
const Contact = () => {
  ...
  const [selectedReferenceLetter, setSelectedReferenceLetter] = useState<
    string | null
  >(null);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (
      ...
      toast.error('looks like you missed some important information.');
      return;
    }
    ...
    try {
      ...
      // Success - trigger paper plane animation
      setIsPlaneAnimating(true);

      // Show success toast with delay
      setTimeout(() => {
        toast.success(
          'Thanks for your interest! I will reach out as soon as possible.',
          {
            duration: 3500,
          }
        );
      ...
      let errorMessage = 'looks like you missed some important information.';

      if (err instanceof TypeError && err.message === 'Failed to fetch') {
        errorMessage =
          'Unable to connect to server. Please make sure the backend server is running on http://localhost:5001';
  ...
  return (
    <div className="section-content">
                ...
                <div key={referral.id} className="referral-item">
                  <div className="referral-content">
                    ...
                    <div className="referral-row-2">
                      <div className="referral-position-company">
                        ...
                        <span className="referral-company">
                          {referral.company}
                        </span>
                      </div>
                      <div className="referral-contact-info">
                  ...
                  {referral.referenceLetter && (
                    <button
                      ...
                      onClick={() =>
                        setSelectedReferenceLetter(
                          referral.referenceLetter || null
                        )
                      }
                    >
          ...
          <form className="contact-form" onSubmit={handleSubmit}>
            ...
            <div className="form-buttons">
              ...
              >
                ...
                <svg
                  className={`paper-plane-icon ${isPlaneAnimating ? 'animate' : ''}`}
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="2"
      ...
      {selectedReferenceLetter && (
        ...
        >
          <div
            className="reference-modal-content"
